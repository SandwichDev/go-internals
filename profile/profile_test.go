...
#	0x4a2be0	main.main.func3+0x70		/go/src/github.com/SandwichDev/go-internals/pprof/profile/a_binary.go:58

34035731690 15760 @ 0x45e851 0x45f764 0x4a2b17 0x44ea31
#	0x45e850	sync.(*Mutex).Unlock+0x80	/go/src/sync/mutex.go:126
#	0x45f763	sync.(*RWMutex).Unlock+0x83	/go/src/sync/rwmutex.go:125
#	0x4a2b16	main.main.func2+0xd6		/go/src/github.com/SandwichDev/go-internals/pprof/profile/a_binary.go:48
`,
		},
		{
			name:    "empty",
